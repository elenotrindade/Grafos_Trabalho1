...
Grafo::Grafo(int num_vertices) // construtor passando o numero de vertices do grafo
{
...
void Grafo::adicionarVertice(int id) { // adiciona um vertice com o d passado por parametro
    Vertice vertice = Vertice(id); // instancia o objeto
    vertices.push_back(vertice); // adiciona o vertice na lista de vertices do grafo
}

void Grafo::removerVertice(int id) { // remove um vertice da lista de acordo com id passado por parametro
...
void Grafo::adicionarAresta(int id_vertice_1, int id_vertice_2) { // adiciona nas listas de arestas dos dois vertices o id um no outro
    list <Vertice>::iterator it; // iterador de uma lista de vertices
...
void Grafo::removerAresta(int id_vertice_1, int id_vertice_2){ // remove nas listas de arestas dos vertices a aresta que relacionam esses dois vertices
...
int Grafo::getGrau(int id_vertice){ // retorna o grau de um vertice com o id passado por parametro
    list <Vertice>::iterator it; // iterador
...
int Grafo::getNumeroVertices(){ // retorna o tamanho da lista de vertices
    return this->vertices.size();
}

void Grafo::imprimirVertices() { // imprime uma listagem com os id dos vertices presentes no grafo
...
void Grafo::imprimirArestas(int id_vertice){ // imprime uma listagem da arestas de um vertice que tem id igual ao passado por parametro
    list <Vertice>::iterator it;
